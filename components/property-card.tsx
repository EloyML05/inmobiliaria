...
export default function PropertyCard({property}:{property:PropertyModel}) {
    const imgSrc = `/images/properties/${property.images[0]}`
  ...
  return (
    ...
    <div className="p-4">
      ...
      >
        {!!property.rates.weekly&&<p><FaMoneyBill/> Weekly</p>}
        {!!property.rates.monthly&&<p><FaMoneyBill/> Monthly</p>}
        {!!property.rates.nightly&&<p><FaMoneyBill/> Nightly</p>}
